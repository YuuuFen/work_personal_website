    ...
    <div>
        <form action="../api/edit_about.php" method="post">
            <table>
                <!-- <tr>
                    <td>ID</td>
                    <td><input type="text" class="w-100" name="id" id="id" value="<?= $row['id'] ?>" disabled></td>
                </tr> -->
                <tr>
                    <td>中文名</td>
                    <td><input type="text" class="w-100" name="name_cn" id="name_cn" value="<?= $row['name_cn'] ?>" disabled></td>
                </tr>
                <tr>
                    <td>英文名</td>
