...
<div class="flex-grow-2 bg-white">
    <div class="list-group list-group-flush my-3">
        <a href="./visitor.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-users me-2"></i>Visitors</a>
        <a href="./scheme.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="far fa-eye me-2"></i>Scheme</a>
